...
- [Awesome Hyper](https://github.com/bnb/awesome-hyper)
  ...
  apt install libglib2.0-dev python3 python3-setuptools rpm git curl graphicsmagick icnsutils xz-utils build-essential
  ...
  remove yarn.lock app/yarn.lock + yarn in app/ then projectroot/ for both yarn.lock(we have to downgraded parse-url to 8 to resolve ts issue)
